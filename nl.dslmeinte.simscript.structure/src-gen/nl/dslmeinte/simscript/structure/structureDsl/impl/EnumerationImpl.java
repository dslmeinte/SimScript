 ...
 * <ul>
 *   <li>{@link nl.dslmeinte.simscript.structure.structureDsl.impl.EnumerationImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnumerationImpl extends DefinedTypeImpl implements Enumeration
{
  /**
  ...
  {
    return StructureDslPackage.Literals.ENUMERATION;
  }
  ...
  public EList<EnumerationLiteral> getLiterals()
  {
    if (literals == null)
    {
      literals = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, StructureDslPackage.ENUMERATION__LITERALS);
    }
    return literals;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StructureDslPackage.ENUMERATION__LITERALS:
