package nl.dslmeinte.simscript.generator.simpleDb
...
class DbSchemaGenerator {
	...
	def void generate(DatabaseModel db, IFileSystemAccess fsa) {
	...
	def private createSql(DatabaseModel it)
		...
		--
		-- Database: `«name»`
		-- (Schema generated by nl.dslmeinte.simscript.simpleDb plug-in.)
		--
