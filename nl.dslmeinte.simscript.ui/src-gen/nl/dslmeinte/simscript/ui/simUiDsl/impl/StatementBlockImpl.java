 ...
 * <ul>
 *   <li>{@link nl.dslmeinte.simscript.ui.simUiDsl.impl.StatementBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatementBlockImpl extends MinimalEObjectImpl.Container implements StatementBlock
{
  ...
  {
    return SimUiDslPackage.Literals.STATEMENT_BLOCK;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, SimUiDslPackage.STATEMENT_BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimUiDslPackage.STATEMENT_BLOCK__STATEMENTS:
