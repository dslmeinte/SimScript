...
import com.simlike.simscript.ui.simUiDsl.Binding
import com.simlike.simscript.ui.simUiDsl.BlockElement
import com.simlike.simscript.ui.simUiDsl.ButtonElement
import com.simlike.simscript.ui.simUiDsl.CalendarElement
import com.simlike.simscript.ui.simUiDsl.CallbackExpression
import com.simlike.simscript.ui.simUiDsl.ComponentInvocation
import com.simlike.simscript.ui.simUiDsl.CountdownTimer
import com.simlike.simscript.ui.simUiDsl.DefinedViewable
import com.simlike.simscript.ui.simUiDsl.Element
import com.simlike.simscript.ui.simUiDsl.ElementBody
import com.simlike.simscript.ui.simUiDsl.FrameElement
import com.simlike.simscript.ui.simUiDsl.GroupElement
import com.simlike.simscript.ui.simUiDsl.GroupOrientations
import com.simlike.simscript.ui.simUiDsl.ImageElement
import com.simlike.simscript.ui.simUiDsl.InputElement
import com.simlike.simscript.ui.simUiDsl.InterfaceCallExpression
import com.simlike.simscript.ui.simUiDsl.LabeledTableElement
import com.simlike.simscript.ui.simUiDsl.LabeledTableRow
import com.simlike.simscript.ui.simUiDsl.LineBreakElement
...
import com.simlike.simscript.ui.simUiDsl.ObserveElement
import com.simlike.simscript.ui.simUiDsl.Parameter
import com.simlike.simscript.ui.simUiDsl.ProgressBarTabSet
import com.simlike.simscript.ui.simUiDsl.Quotation
import com.simlike.simscript.ui.simUiDsl.SlotAddElement
import com.simlike.simscript.ui.simUiDsl.TabDeclaration
import com.simlike.simscript.ui.simUiDsl.TableElement
import com.simlike.simscript.ui.simUiDsl.TableRow
...
import com.simlike.simscript.ui.simUiDsl.VerticalAlignment
import com.simlike.simscript.ui.simUiDsl.WhenElement
...
class ElementsGeneratorImpl implements ElementsGenerator {
	...
	def private dispatch jsFunction_(ManualViewable it)
		'''
		// «type.literal» «qualifiedName» is manual

		'''

	def private dispatch jsFunction_(DefinedViewable it)
		'''
		// «type.literal» «name»:
	...
	def private dispatch jsFunction_(TableRowsDefinition it)
		'''
		// table-rows «name»:
		«jsFunctionHead(name, parameters)» {
			«FOR row : rows»
	...
	def private dispatch jsFunction_(MethodDefinition it)
		'''
	 ...
	 */
	def private domCreate(Element it) {
		domCreate_
	}


	def private domCreate(ElementBody it)
		'''
		«FOR element : elements»
			«element.domCreate_»
		«ENDFOR»
	 ...
	 */
	def private dispatch domCreate_(Quotation it)			'''container.append(document.createTextNode(«path.asObservableJs».print()));'''
	 ...
	 */
	def private dispatch domCreate_(ComponentInvocation it)	'''«invocation(ViewableInvocationTypes::nested)»;'''

	def private dispatch domCreate_(LineBreakElement it) '''container.append("<br />");'''

	private int bindingCounter = 0
	def private dispatch domCreate_(Binding it) {
	...
	def private dispatch domCreate_(InputElement el) {
	...
	def private dispatch domCreate_(ButtonElement it) {
	...
	def private dispatch domCreate_(BlockElement it) {
	...
	def private dispatch domCreate_(GroupElement it) {
	...
	def private dispatch domCreate_(ListElement it) {
	...
	def private dispatch domCreate_(TableElement it) {
	...
	def private dispatch tableDomCreate(TableRow it) {
	...
	def private dispatch domCreate_(LabeledTableElement it) {
	...
	def private dispatch domCreate_(LabeledTableRow it) {
	...
	def private dispatch domCreate_(ProgressBarTabSet it)
		'''
	...
	def private dispatch domCreate_(CountdownTimer it) {
	...
	def private dispatch domCreate_(CalendarElement it) {
	...
	def private dispatch domCreate_(TimeSlotListElement it) {
	...
	def private dispatch domCreate_(WhenElement it) {
	...
	def private dispatch domCreate_(ImageElement it) {
	...
	def private dispatch domCreate_(FrameElement it) {
