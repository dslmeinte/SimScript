...
import com.simlike.simscript.backend.simBackendDsl.CrudTypes
import com.simlike.simscript.generator.ResourceUtil
import com.simlike.simscript.generator.util.GeneratorUtil
import com.simlike.simscript.structure.structureDsl.Structure
import org.eclipse.xtext.generator.IFileSystemAccess

import static com.simlike.simscript.backend.simBackendDsl.CrudTypes.*
...
class CrudServletsGenerator {
	...
	def generateCrudServlet(Structure it, CrudTypes service)
		...
		import com.simlike.api.servlets.AbstractSimlikeServlet;
		import com.simlike.api.db.data.util.HttpGetParameterUtil;
		import com.simlike.api.exceptions.MultipleValuesForParameterException;
		import com.simlike.api.exceptions.MandatoryKeyMissingException;
		import com.simlike.api.exceptions.NoResultException;
		import javax.servlet.http.HttpServletResponse;
		import javax.servlet.http.HttpServletRequest;
		import java.io.PrintWriter;
		import java.util.Map;
		import java.util.UUID;
		import com.simlike.api.RequestParameterExtractor;
		import «it.asJavaTypeLiteral»;
		import «it.controller»;
		
		@SuppressWarnings("serial")
		public class «servletName(service)» extends AbstractSimlikeServlet {
