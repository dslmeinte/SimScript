...
class ServletGenerator {
	...
	def generateBaseServlet(Interface it)
		...
		import com.simlike.api.ServletErrorUtil;
		import com.simlike.api.exceptions.ServerException;
		...
		public abstract class Abstract«name.toFirstUpper»Servlet extends «IF notAuthenticated»HttpServlet«ELSE»AbstractSimlikeServlet«ENDIF» {
