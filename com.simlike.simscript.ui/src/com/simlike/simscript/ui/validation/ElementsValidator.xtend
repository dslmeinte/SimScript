...
import com.simlike.simscript.ui.simUiDsl.StructureOption
...
class ElementsValidator extends ValidatorSupport {
	...
	def private check_element_inside_labeled_table(Element it) {
		switch it {
			LabeledTableRow:	false
	...
	def private <T> traverseForLabeledTable(ElementBody it) {
